 ...
 */
	...
	class XmlRPCRouter implements \ABPHPF\Routers\IRouter {
	  ...
	  /**
	   * Array map method to XmlRPC routers
	   * 	   
	   *@return void
	   */
...
/*
	  ...
	  /**
	   * Check if Request method is XML application
	   * 	   
	   * If have XML request this method return true or not return false	   
	   *@return bool
	   */
		public function isXMLRequest() {
			return (($this->getRequest() != 'POST' || empty($this->serverContentType()) || $this->serverContentType() != 'application/xml')?false:true );
		}//isJsonRequest()
